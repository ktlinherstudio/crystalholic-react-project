            ...
            <main className="index-numtest3">
                <div id="left">
                    ...
                    <div className="imgp0-box">
                        <img className="img-p0" src="./images/Numtest/characters/numCharacter_1.png" alt="" />
                    </div>
                </div>
                <div id="right">
                    {/* 標籤 */}
                    ...
                    <div id="box1">
                        ...
                        <div className="friends">
                            ...
                            <ul className="people-box">
                                <li className="people">
                                    <img className="img-p1" src="./images/Numtest/characters/numCharacter_s3.svg" alt="" />
                                    <div>
                                ...
                                <li className="people">
                                    <img className="img-p2" src="./images/Numtest/characters/numCharacter_s5.svg" alt="" />
                                    <div>
                                ...
                                <li className="people">
                                    <img className="img-p3" src="./images/Numtest/characters/numCharacter_s7.svg" alt="" />
                                    <div>
                        ...
                        <div className="enemies">
                            ...
                            <ul className="people-box2">
                                <li className="people">
                                    <img className="img-p4" src="./images/Numtest/characters/numCharacter_s8.svg" alt="" />
                                    <div>
                                ...
                                <li className="people">
                                    <img className="img-p5" src="./images/Numtest/characters/numCharacter_s9.svg" alt="" />
                                    <div>
                                ...
                                <li className="people">
                                    <img className="img-p6" src="./images/Numtest/characters/numCharacter_s1.svg" alt="" />
                                    <div>
                        ...
                        <div className="crystals">
                            ...
                            <ul className="crystal-box">
                                <li className="crystal">
                                    <img className="img-p7" src="./images/S-CrystalSingle/crystal-citrine.png" alt="" />
                                    <div>
                                ...
                                <li className="crystal">
                                    <img className="img-p8" src="./images/S-CrystalSingle/crystal-green-phantom.png" alt="" />
                                    <div>
                                ...
                                <li className="crystal">
                                    <img className="img-p9" src="./images/S-CrystalSingle/crystal-kyanite.png" alt="" />
                                    <div>
