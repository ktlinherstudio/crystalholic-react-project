...
export default function CoverTest() {
    ...
    const TarotSection = () => {
        ...
        const tarotImages = [
            "./images/HomePage/tarot-back.svg",
            "./images/HomePage/tarot-back.svg",
            "./images/HomePage/tarot-back.svg",
            "./images/HomePage/tarot-back.svg",
            "./images/HomePage/tarot-back.svg",
        ...
        return (
            <>
                ...
                <section id="section-tarotcard">
                    <div id="tarotcard-box" className="flex flex-wrap gap-4 justify-center">
                        {tarotImages.map((img, index) => (
                            <img
                                key={index}
                                src={img}
                                className="trcard w-24 cursor-pointer transition-transform hover:scale-105"
                    ...
                    {lightboxOpen && (
                        ...
                        >
                            <img src={selectedImage} className="max-w-md max-h-[90vh]" alt="Selected Tarot" />
                        </div>
                    )}
                </section>
