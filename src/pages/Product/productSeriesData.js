...
const productSeriesData = {
  ...
  seasons: {
    name: "四季琉波",
    description: [
      "四季琉波，將自然的韻律化為水晶的柔光波動。",
      "從春芽初綻到雪森靜謐，這四款設計象徵生命的流轉與能量的循環。",
      "每一季節皆對應不同的情緒節奏與能量需求，讓水晶如節氣般陪伴你溫柔變化，",
      "學會在每個當下，順流而行、與內在共舞。"
    ],
    products: [
      {
        ...
        description: [
          "如嫩芽破土的第一道柔光，主石葡萄石象徵新的開始與內在的整理，幫助清除舊有能量、開啟心靈更新。櫻花瑪瑙與摩根石則注入柔和的溫暖與希望，是適合轉換階段、重新出發時的能量配戴。"
        ],
        crystals: [
      ...
      },
      {
        ...
        description: [
          "靈感來自澳洲海灣的陽光午後，主石水草瑪瑙象徵流動中的穩定，幫助心緒沉澱、情緒柔軟。與摩根石的溫柔心輪共振，搭配虎眼與緬甸玉的生命力加持，讓你在熱烈生活中仍保有從容與自我。"
        ],
        crystals: [
      ...
      },
      {
        ...
        description: [
          "如雪靜謐、如夜溫柔，主石藍玉髓帶來深層的寧靜與靜心表達力，是冬季最適合的療癒能量石。搭配雪花瑪瑙與月光石的夢幻頻率，引導你進入更深的內在世界，擁抱黑夜、沉澱情緒。"
        ],
        crystals: [
